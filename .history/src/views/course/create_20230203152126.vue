    ...
    <el-card>
      ...
      <el-form label-width="80px">
        ...
        <div v-show="activeStep === 1">
          <!-- 封装图片上传组件 -->
          <course-image v-mdel="course.courseListImg" label="课程封面" :limit="3"></course-image>
          <course-image v-mdel="course.courseImgUrl" label="解锁封面" :limit="3"></course-image>
        </div>
        <!-- 销售信息 -->
        ...
        <div v-show="activeStep === 3">
          ...
          <template v-if="course.activityCourse">
            ...
            <el-form-item label="秒杀价">
              <el-input placeholder="请输入价格" v-model="course.activityCourseDTO.amount" type="numder" :min="0">
                <template slot="append">元</template>
              </el-input>
            </el-form-item>
            <el-form-item label="库存">
              <el-input placeholder="请输入库存" v-model="course.activityCourseDTO.stock">
