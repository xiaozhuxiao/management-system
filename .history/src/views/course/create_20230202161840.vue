      ...
      <el-form>
        ...
        <div v-show="activeStep === 3">
          ...
          <template v-if="isSeckill">
            ...
            <el-form-item label="秒杀价" slot="label" style="font-size: 14px; letter-spacing: 0.33em">
              <el-input placeholder="请输入价格">
                <template slot="append">元</template>
              </el-input>
            </el-form-item>
            <el-form-item label="库存" slot="label" style="font-size: 14px; letter-spacing: 0.33em">
