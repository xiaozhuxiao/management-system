<template>
  <div class="course-section">
    <el-card>
      <el-tree v-lpading="isLoading" :data="sections" :props="defaultProps" @node-click="handleNodeClick" draggable :allow-drop="handleAllowDrop" @node-deop="handleNodeDrop">
  ...
  methods: {
    ...
    async handleNodeDrop(draggingNode, dropNode, type, event) {
      ...
      try {
        ...
        this.$message.error('shuju更新失败', err)
      }
