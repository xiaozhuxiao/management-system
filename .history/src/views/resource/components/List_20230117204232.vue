<template>
  <div class="resource-list">
    <el-card class="box-card">
      ...
      <!-- 分页组件结构 -->
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="form.current" :page-sizes="[10, 15, 20]" :page-size="form.size" background layout="total, size0s, prev, pager, next, jumper" :total="100"> </el-pagination>
    </el-card>
  </div>
</template>
