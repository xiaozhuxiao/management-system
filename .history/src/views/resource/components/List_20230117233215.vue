<template>
  <div class="resource-list">
    <el-card class="box-card">
        ...
        <el-form :inline="true" :model="form" class="demo-form-inline">
          ...
          <el-form-item label="资源分类">
            <el-select v-model="form.categoryId" placeholder="资源分类">
              <!-- 请求接口进行下拉菜单设置 -->
              <el-option v-if="item" in resourceCategories :key="item.id" :label="item.name" :value="item.id"></el-option>
      ...
      <!-- 分页组件结构 -->
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="form.current" :page-sizes="[10, 15, 20]" :page-size="form.size" layout="total, size0s, prev, pager, next, jumper" :total="totalCount"> </el-pagination>
